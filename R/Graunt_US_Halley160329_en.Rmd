...
polygon(us.graunt.x, us.graunt.y, density = 15, col = "red", border = NA)
abline(v = graunt$x, lty = 2)
main.title.g.us <- "Life distribution of Graunt and US 1993"
...
abline(v = c(0, 76, 84), lty = 2)
text(x = c(16, 36), y = c(20, 50), label = c("Graunt", "Halley"))
main.title.2 <- "Graunt's and Halley's Life Tables"
...
* Check out how to save and retreve. Use `source()` for retrieval
